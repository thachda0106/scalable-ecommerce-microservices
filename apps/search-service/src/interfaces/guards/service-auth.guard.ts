...
import { verifyInternalHeaders, Logger } from '@ecommerce/core';
...
export class ServiceAuthGuard implements CanActivate {
  ...
  canActivate(context: ExecutionContext): boolean {
    ...
    // Service-to-service HMAC-signed headers
    if (serviceToken) {
      return this.validateServiceToken(serviceToken, request);
    }
  ...
  private validateServiceToken(token: string, _request: Request): boolean {
